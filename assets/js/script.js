...
function darkMode() {
    ...
    document.getElementById("client2-light").style.display = 'none'
    document.getElementById("client2-dark").style.display = 'block'
    ...
    document.getElementById("tecnico-dark").style.display = 'block'
    document.getElementById("tecnico-light").style.display = 'none'
    document.getElementById("tecnico-dark").style.display = 'block'
    document.getElementById("estagio-light").style.display = 'none'
    document.getElementById("estagio-dark").style.display = 'block'
    document.getElementById("freelance1-light").style.display = 'none'
    document.getElementById("freelance1-dark").style.display = 'block'
    ...
    document.getElementById("1.1").style.color = '#FFF'
...
function lightMode() {
    ...
    document.getElementById("client2-light").style.display = 'block'
    document.getElementById("client2-dark").style.display = 'none'
    ...
    document.getElementById("estagio-dark").style.display = 'nonce'
    document.getElementById("freelance1-light").style.display = 'block'
    document.getElementById("freelance1-dark").style.display = 'none'
